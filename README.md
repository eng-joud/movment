...
Create a movement table with the following SQL:
...
4. Set Up Project
Clone this repository into the XAMPP htdocs directory (e.g., C:\xampp\htdocs).
...
Usage
1.Open the browser and go to http://localhost/robot_control/index.php to control the robot 
2.Navigate to      http://localhost/robot_control/display.php to view the last movement direction.
